// The classic forecaster: the moving-pace regression on its own.
//
// This is the model the site shipped with, kept intact as the backbone every
// other file in this directory builds on and as a selectable model in its own
// right (`?model=classic`). Its known limitation is stated at `fitPace` below —
// stopped time widens the band but never delays the ETA — and the other models
// here exist to price exactly that.
//
