...
//
// There are five colours and each one means something: a ping, the course, the
// person looking at the page, somebody other than the runner with a camera, and
// the surface they all sit on. Every ping is the
...
/** A photograph the CREW took. The runner isn't in it and wasn't near it, so it
 *  can be neither the accent — which is reserved for readings off his phone — nor
 *  the course purple, which is for positions computed onto his route. */
export const crew    = () => getPalette().crew;
